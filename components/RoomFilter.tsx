...
const ROOM_PILL_CLASSES: Record<Room | 'All', string> = {
  ...
  'Yonge Room': 'border-indigo-200 bg-indigo-50 text-indigo-700 hover:border-indigo-300 hover:bg-indigo-100',
  'Bay Room': 'border-red-200 bg-red-50 text-red-700 hover:border-red-300 hover:bg-red-100',
  'Richmond Room': 'border-amber-200 bg-amber-50 text-amber-700 hover:border-amber-300 hover:bg-amber-100',
  'Adelaide Room': 'border-emerald-200 bg-emerald-50 text-emerald-700 hover:border-emerald-300 hover:bg-emerald-100',
...
const ROOM_SHORT_LABELS: Record<string, string> = {
  'All': 'All',
  'Yonge Room': 'Yonge Room',
  'Bay Room': 'Bay Room',
  'Richmond Room': 'Richmond Room',
  'Adelaide Room': 'Adelaide Room',
  'Lunch Room': 'Unconf',
}
